...
- **后台自动备份** — WiFi + 电量充足时自动扫描并备份新照片
- **全格式支持** — JPEG、HEIC、RAW、Live Photo、动态照片
- **Web 图片浏览** — 浏览器中查看已备份照片、缩略图预览、原图下载
...
3. 支持拖拽上传照片
4. 支持原图下载
5. **回收站管理** — 查看已删除的照片，支持恢复或彻底删除，显示剩余保留时间
