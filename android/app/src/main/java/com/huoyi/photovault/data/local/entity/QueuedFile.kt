package com.huoyi.photovault.data.local.entity
 ...
 *
 * The in-memory [com.huoyi.photovault.service.BackupQueue] is the authoritative queue
 * while the process is alive; this table is a durable mirror of it. Each row maps
 * one-to-one to a [com.huoyi.photovault.service.FileInfo]. On process start the queue
